...
while True:
    ...
    if opcao == '1':
        ...
        # Aqui você pode adicionar o código para acessar o sistema de delivery
        break
    elif opcao == '2':
        print('Fazendo reserva...')
        # Aqui você pode adicionar o código para fazer uma reserva
        break
    elif opcao == '3':
        print('Verificando menu...')
        # Aqui você pode adicionar o código para verificar o menu
        break
    elif opcao == '4':
        print('Verificando cardápio...')
        # Aqui você pode adicionar o código para verificar o cardápio
        break
    elif opcao == '5':
        print('Avaliando restaurante...')
        # Aqui você pode adicionar o código para avaliar o restaurante
        break
    elif opcao == '0':
        print('Saindo...')
        break
...
jeito antigo de fazer o menu, sem o while, mas ai ele só executa uma opção e depois para, não é tão interativo.
